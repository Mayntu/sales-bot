...
def build_app() -> Application:
    ...
    admin_chats = _parse_admin_chat_ids(s.admin_telegram_chat_ids)
    if admin_chats and not s.admin_secret:
        log.warning("Задан ADMIN_TELEGRAM_CHAT_IDS, но пустой ADMIN_SECRET — админ-команды в Telegram отключены")
